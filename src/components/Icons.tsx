...
export const QuestionHint: FC<IIconProps> = (props) => {
    return (
        <IconWrapper icon={
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="bi bi-patch-question-fill" viewBox="0 0 16 16">
...
export const ThreeDots: FC<IIconProps> = (props) => {
    return (
        <IconWrapper icon={
